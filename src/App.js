...
function App() {
  ...
  return (
    ...
    <TaskList prevTasks={filteredTasks} taxterraHandleChange={handleChange} prevText={prevText} updateTask={updateTask} setFilter={setFilter} filter={filter} searchQuery={searchQuery} setSearchQuery={setSearchQuery} addTask={addTask} />
